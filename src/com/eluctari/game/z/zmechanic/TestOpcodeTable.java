...
public class TestOpcodeTable {
	...
	@Test public void test2() {
		OpcodeTable.INSTANCE.get(Instruction.OperandCount.OC_2OP, "add");
	}
	...
	@Test public void test3() {
		Opcode o = OpcodeTable.INSTANCE.get(Instruction.OperandCount.OC_2OP, "add");
		assertEquals(o.getByte(0), (byte)20);
	}
	
	@Test public void test4() {
		Opcode o = OpcodeTable.INSTANCE.get(Instruction.OperandCount.OC_VAR, "buffer_mode");
		assertEquals(o.getByte(0), (byte)242);
	}
	
	@Test public void test5() {
		Opcode o = OpcodeTable.INSTANCE.get(Instruction.OperandCount.OC_EXT, "art_shift");
